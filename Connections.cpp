...
//  Description : connections class implementation 
//  Date		: 02 Jan 2002 
...
void connections::insert(string imsi, connection_detail &a)
{
	...
	if (q.second == false)
	{
		...
		// removed the cout to speed up loading - cjn
	}

	// call partner pone imisi inter tie
...
// may have changed their sim numbers. (valid only for 3 months.
